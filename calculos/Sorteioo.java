...
public class Sorteioo {
  ...
  public static void Loteria() {
    Random Sorteioo = new Random();

        for (int i = 0; i < 6; i++) {
            numSorteados[i] = Sorteioo.nextInt(60) + 1;
        }
    }
    ...
    public static void main (String[] args) {
        ...
        do {
            ...
            if (posicao > 0) {
                ...
                for (num = 0; num == 5; num++){
                System.out.println("Seu prêmio é de R$250.000,00");
            }
                break;

                for (num = 0;num == 4; num++){
                System.out.println("Seu prêmio é de R$50.000,00");
            }
                break;

                for (num =0; num <= 3; num++){
                    System.out.println("Você não recebe nada :p");
            }
                break;
